...
export const createListSheetStyles = (listTheme: ListTheme) => {
  ...
  return StyleSheet.create({
    ...
    header: {
      ...
      paddingHorizontal: sheet.headerBarPaddingHorizontal,
      paddingVertical: sheet.headerBarPaddingVertical,
      borderRadius: sheet.headerBarRadius,
      borderWidth: sheet.headerBarBorderWidth,
      backgroundColor: "transparent",
    ...
    bottomActionBar: {
      position: "absolute",
      left: sheet.bottomActionInset,
      right: sheet.bottomActionInset,
      bottom: sheet.bottomActionBottom,
      flexDirection: "row",
      gap: sheet.bottomActionGap,
    },
    bottomActionButton: {
      flex: 1,
      borderRadius: sheet.bottomActionRadius,
      paddingVertical: sheet.bottomActionPaddingVertical,
      alignItems: "center",
      justifyContent: "center",
      borderWidth: 1,
    },
    bottomActionText: {
      fontSize: sheet.bottomActionTextSize,
      fontWeight: sheet.bottomActionTextWeight as "700",
    },
    subMenuContainer: {
