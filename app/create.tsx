...
import { Dimensions, Keyboard, KeyboardAvoidingView, Modal, Platform, Pressable, StyleSheet, Text, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native'
        ...
        {() =>
          <View style={categoryStyles.card}>
            ...
            >
              {Category$.get().map((item, index) => (
                <View key={item.id}>
                  ...
                  >
                    ...
                    <View style={{ width: '100%', height: 0, borderWidth: 0.5, borderColor: 'rgba(0, 0, 0, 0.3)', marginTop: 3}}/>
                  </TouchableOpacity>
                </View>
              ))}
              ...
              <TouchableOpacity
                key={-1}
                style={[categoryStyles.row, categoryStyles.createCategory, {marginTop: 1}]}
                onPress={() => {
              ...
              >
                {/* <View> */}
                  <AntDesign name="addfile" size={16} color={"rgba(0, 0, 0, 0.3)"} />
                  <Text style={[categoryStyles.label, { marginLeft: 5}]}>Add Category</Text>
                {/* </View> */}
              </TouchableOpacity>
            </ScrollView>
          </View>
...
const create = () => {
  ...
  return (
    <View style={styles.overlay}>
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false} style={styles.transparentFlex}>
